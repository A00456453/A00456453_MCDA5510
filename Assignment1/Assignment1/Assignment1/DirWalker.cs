...
namespace Assignment1
{
    ...
    public class DirWalker
    {
        ...
        public void walk(String path, ref string content,ref int errorcount, ref int normalcount)
        {
            ...
            File.AppendAllText("E:\\SoftwareClass\\output\\output.csv", content);
            content = "";
        }
        ...
        public static void Main(String[] args)
        {
            ...
            File.WriteAllText("E:\\SoftwareClass\\output\\output.csv", "");
           ...
           long time = watch.ElapsedMilliseconds;
            ...
            File.AppendAllText("E:\\SoftwareClass\\output\\output.csv", "total skipped records-" + errorcount + " total records-" + normalcount + " time taken ms:" + time);
